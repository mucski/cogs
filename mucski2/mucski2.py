...
class Mucski2(commands.Cog):
    ...
    @vip.command()
    async def start(self, ctx, time: int, channel: discord.TextChannel=None, *, text="Daily ☢️V.I.P Supreme☢️ giveaway.\nReact bellow to enter 💎"):
        if channel == None:
            channel = ctx.channel
        ...
        remaining = datetime.fromtimestamp(future.timestamp()) - now
