...
class Coin(TaskHelper, commands.Cog):
    ...
    async def info(self, ctx):
        ...
        embed.add_field(name = "Pet Name", value = pet[4].capitalize())
        embed.add_field(name = "Pet Type", value = f"{emoji} ({pet[5]})")
        embed.add_field(name = "Pet Hunger", value = pet[1])
        embed.add_field(name = "Pet Clean", value = pet[2])
        embed.add_field(name = "Pet Happy", value = pet[3])
