...
class helper2:
    ...
    async def statsimage(cls, champicon, rankicon, stats, index):
        ...
        #self healing
        draw.text((img_x * 11 - offset - offset / 4, middle), humanize_number(stats[9]), font=fnt, color=fill)
        #kda2
        draw.text((img_x * 12 - offset - offset / 4, middle), stats[10], font=fnt, color=fill)
        return img
