...
class helper2:
    ...
    async def statsimage(cls, champicon, rankicon, stats, index):
        ...
        draw.text((512 + padding * 4, mid + 20), str(stats[1]), font=smallfnt, color=fill)
    ...
    async def middlepanel(cls, match_data):
        ...
        draw.text((int(W / 2 + 183), 300 + padding), f"Team 2 score: {match_data[5]}", font = fnt, stroke_width = stroke_size, stroke_fill = stroke, fill = fill)
