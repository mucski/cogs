...
class helper:
    ...
    async def middle_panel(cls, md):
        ...
        draw_panel.text((rs, 0 + ds),
                        str(f"ID: {md[0]}"), font=fnt100, fill=fill, stroke_width=1, stroke_fill=stroke)
        draw_panel.text((rs, 100 + ds), (str(md[1]) + " minutes"), font=fnt100,
                        fill=fill, stroke_width=1, stroke_fill=stroke)
        draw_panel.text((rs, 200 + ds),
                        str(md[2]), font=fnt100, fill=fill, stroke_width=1, stroke_fill=stroke)
        ...
        draw_panel.text((512 * 4 - 230, ds), f"Team 1 Score: {md[4]}",
                        font=fnt100bold, fill=(76, 104, 245), stroke_width=4, stroke_fill=fill)
        center = (512/2 - 130/2)
        center2 = (512/2 - 80/2)
        # VS
        ...
        draw_panel.text((512 * 6 - 200, 348), f"Team 2 Score: {md[5]}",
                        font=fnt100bold, fill=(245, 76, 76), stroke_width=4, stroke_fill=fill)
        #  add in banned champs if it's a ranked match
        try:
            if md[6]:
                # Ranked bans
                draw_panel.text((512 * 9 + 100, center2),
                                "Bans:", font=fnt100, fill=fill, stroke_width=1, stroke_fill=stroke)
                # Team 1 Bans
                try:
