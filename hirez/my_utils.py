...
async def create_player_stats_image(champ_icon, champ_stats, index, party, color=False):
    ...
    base_draw.text((img_x + 20, middle-40), str(champ_stats[0]), font=ImageFont.truetype("/home/music166/mucski/arialbd.ttf", 80),)
    base_draw.text((img_x + 20, middle+60), str(champ_stats[1]), font=ImageFont.truetype("/home/music166/mucski/arial.ttf", 80),)
