...
class Hirez(commands.Cog):
    ...
    def __init__(self, bot):
        ...
        self.api = arez.PaladinsAPI(dev_id = self.devid, auth_key = self.auth)
    ...
    async def stats(self, ctx, player, platform = "pc"):
        ...
        embed.add_field(name="Current rank", value=f"{player.ranked_best.rank} ({player.ranked_best.points} TP)")
